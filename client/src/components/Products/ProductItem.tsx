...
const ProductItem = ({ product }: propsType) => {
  ...
  return (
    <div
      ...
      className="relative top-0 mt-8 flex h-[330px] w-[210px] flex-col items-center rounded-md border border-[#959191] p-3"
    >
          ...
          <div className="flex h-[100%] flex-col justify-around font-medium text-[#fff] transition-all">
            ...
            <div className="flex animate-[goUp_0.25s_ease-in-out] justify-center gap-4 text-2xl">
              <div className="relative mr-5 ">
                <i className="peer  absolute cursor-pointer">
                  <FaRegHeart />
                </i>
                <i className="absolute hidden cursor-pointer peer-hover:block">
                  <AiFillHeart />
                </i>
              </div>
